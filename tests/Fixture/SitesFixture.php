...
class SitesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'modified_by' => ['type' => 'integer', 'length' => 10, 'unsigned' => true, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_constraints' => [
    ...
    public $records = [
        [
            ...
            'created' => '2016-06-25 20:58:43',
            'modified' => '2016-06-25 20:58:43',
            'status' => 1,
            'created_by' => 1,
            'modified_by' => 1
        ],
